...
#
#
user = User.create({name: "admin", email: "admin1234@gmail.com", password: "Admin123456", photo: "https://res.cloudinary.com/poppycloud/image/upload/v1528189893/wacukhrblsxdcwsbmrqi.jpg", role: "Administrator"})
